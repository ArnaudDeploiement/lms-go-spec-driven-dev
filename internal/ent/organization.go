...
// was not loaded in eager-loading.
func (e OrganizationEdges) ContentsOrErr() ([]*Content, error) {
	if e.loadedTypes[1] {
...
// was not loaded in eager-loading.
func (e OrganizationEdges) CoursesOrErr() ([]*Course, error) {
	if e.loadedTypes[2] {
	...
	for i := range columns {
		...
		case organization.FieldSettings:
			if value, ok := values[i].(*[]byte); !ok {
				...
				if err := json.Unmarshal(*value, &o.Settings); err != nil {
...
// QueryContents queries the "contents" edge of the Organization entity.
func (o *Organization) QueryContents() *ContentQuery {
	return NewOrganizationClient(o.config).QueryContents(o)
}
...
func (o *Organization) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", o.Settings))
	builder.WriteString(", ")
