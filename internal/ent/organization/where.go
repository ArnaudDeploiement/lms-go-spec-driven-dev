...
func HasContents() predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasContentsWith(preds ...predicate.Content) predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
...
func HasCourses() predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasCoursesWith(preds ...predicate.Course) predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
		step := newCoursesStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
...
func HasEnrollments() predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasEnrollmentsWith(preds ...predicate.Enrollment) predicate.Organization {
	return predicate.Organization(func(s *sql.Selector) {
